...
import { getProductsDetails, clearErrors} from '../../actions/productAction'
import { Carousel } from 'react-bootstrap'
import {useParams} from 'react-router-dom'

// doubt {product.name} is which we get from state.productDetails or thriugh useEffect
const ProductDescription = () => {
console.log("Message" ,useParams())
